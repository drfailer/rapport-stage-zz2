...
sont correctement enregistrées puis envoyées sur le serveur. % j'aime moins la fin
...
et d'éliminer les framework incomplets ou trop peu utilisés. Une fois le
...
\section{Organisation du projet} % pas sûr de cette partie, elle fait un peu fourre-tout
