...
l'entreprise. Comme dit précédemment, le répertoire \verb|dev_pic| contient
...
stockés dans le répertoire \verb|C32| dans \verb|dev_pic|. Dans, ce
...
définie dans le fichier \verb|PicVariables| mentionné dans la section
\ref{fakeprojgcc}.
...
fonctions dans le fichier du répertoire \verb|C32|. La lecture suis le même
...
commandes, les fichier \verb|CctalkMaster.c| et
\verb|CctalkMasterSerial.c|).
