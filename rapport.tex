...
de lavage auto sont équipé de bornes CKsquare.
...
savoir faire quant à la gestion de la plupart des systèmes de payements. De
plus, une équipe SAV reste à l'écoute du besoin des clients ce qui permet à
l'entreprise de concevoir des solutions encore plus spécifiques et
personnalisées.
...
parler de l'environnement dans l'entreprise... et des outils
- travail seul
- aide disponible
- pc sous linux
...
\subsection{Contrainte pour compiler}

\subsection{Machines à états}

\section{Les premiers tests}

Tools, machines, cashregister

Fichiers simples au départ car il était très compliquer de compiler le projet
sans les bibliothèques et le compilateur de la carte.

\subsection{Différents types de fichiers à tester}

\subsubsection{Tools: fonctions basiques}

\subsubsection{Cashregister et machines: tester des machines à états}

contrainte => pas d'acces aux états, ... on doit tester l'environnement

\subsection{Versions tests}

\subsection{Organisation du projet de test}

Organisation du répertoire, philosophie quand à la copie de fichiers lorsqu'il y
a des modifications à faire, substitution des bibliothèques.
