...
demander son adresse à un composant. Il y a en tout 255 entête différentes ce
qui permet la transmission d'une entête sur un octet. Les entêtes de 20 à 100
sont réservées pour les développeurs des applications utilisant le Cctalk, le
reste est décrit dans la documentation \cite{cctalkpt2}. Sur la figure
\ref{tramecctalk} on peut voir la composition d'une trame Cctalk. Une trame se
compose des six éléments. Le premier est l'adresse du composant ciblé par la
...
\begin{figure}[h!]
  \begin{center}
  \includegraphics[scale=0.6]{./img/trame-cctalk.png}
