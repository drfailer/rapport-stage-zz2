...
s'exécute. Le débogueur qui a été utilisé est GDB (GNU Debugger).

GDB est un outil très puissant, il permet de suivre l'exécution du code,
d'évaluer des expressions et même d'interagir avec le code en modifiant les
valeurs des variables de façon interactive pendant une session.
