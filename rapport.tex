...
% TODO: une partie de l'arborescence est normalement présentée dans la partie
% précédente
...
normalement sur des cartes électronique, il fallait que l'outil mette en place
...
encourageant, car le peu de tests qui ont été écrit durant le stage ont déjà
...
des thread, elle était lourde et difficile à mettre en œuvre. Par la suite, nous
avons décidé de simplifier au maximum ce qui a fait gagné beaucoup de temps.\\
